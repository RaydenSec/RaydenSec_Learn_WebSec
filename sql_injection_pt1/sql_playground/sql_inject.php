...
<body>
    ...
    <p>First thing's first, before we can perform a basic sql injection, we first need to understand how we're connecting and passing SQL queries into our mySQL database using php.
        ...
        Make sure to start Apache and MySQL on XAMPP. After that, we'll head over to <b>127.0.0.1/phpmyadmin</b> on a web browser. We're essentially going to a MySQL administration tool on our localhost (our local machine).
    </p>
